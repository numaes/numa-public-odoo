...
class crm_lead2opportunity_partner(osv.osv_memory):
    ...
    def onchange_partner_id(self, cr, uid, ids, partner_id, context=None):
        if partner_id:
            ...
            lead_ids = lead_obj.search(cr, uid, [('type','=','opportunity'), ('partner_id','=', partner_id),'!', ('state', 'in', ['done', 'cancel'])])
            return {'value': {'opportunity_ids': lead_ids and [lead_ids[0]] or [], 'partner_name': partner.name}}
        return False
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        if partner_id:
            ...
            ids = lead_obj.search(cr, uid, [('partner_id', '=', partner_id), ('type', '=', 'opportunity'), ('id', 'not in', lead_ids), '!', ('state', 'in', ['done', 'cancel'])])
            if ids:
        ...
        if 'partner_id' in fields:
            ...
            if partner_id:
                ...
                res.update({'partner_name': partner.name})
        if 'name' in fields:
    ...
    def action_apply(self, cr, uid, ids, context=None):
        ...
        lead_id = self._merge_opportunity(cr, uid, ids, data.opportunity_ids, data.name, context=context)
        return lead.redirect_opportunity_view(cr, uid, lead_id, context=context)
