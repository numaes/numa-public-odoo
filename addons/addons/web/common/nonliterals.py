...
class Context(BaseContext):
    ...
    def evaluate(self, context=None):
        ...
        try:
            ...
            logger.error('Error during evaluation of this context: "%s", message: "%s"' % (self.get_context_string(), e.message))
            return {}
...
class CompoundContext(BaseContext):
    ...
    def evaluate(self, context=None):
        ...
        for context_to_eval in self.contexts:
            ...
            #logger.debug("CD EVAL %s, %s" % (ctx, context_to_eval.evaluate(ctx)))
