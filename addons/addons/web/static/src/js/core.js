...
openerp.web.Widget = openerp.web.CallbackEnabled.extend(/** @lends openerp.web.Widget# */{
     ...
     */
    appendTab: function(target, tab_name) {
        this._rename_tab_id();
        this._new_tab(tab_name);
    ...
    _rename_tab_id: function() {  
        ...
        $('#' + this.element_id).addClass("oe-application ui-tabs-panel ui-widget-content ui-corner-bottom");
    },
    _new_tab: function(tab_name) {
