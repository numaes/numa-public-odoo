...
class mrp_bom(osv.osv):
    ...
    def _bom_explode(self, cr, uid, bom, factor, properties=[], addthis=False, level=0, routing_id=False):
        ...
        factor = rounding(factor, bom.product_rounding or 1.0) 
...
class mrp_production(osv.osv):
    ...
    def action_compute(self, cr, uid, ids, properties=[], context=None):
        ...
        for production in self.browse(cr, uid, ids):
            ...
            rest = factor % bom_point.product_qty
            if rest > 0:
                factor += (bom_point.product_qty - rest)
    ...
    def _make_production_internal_shipment_line(self, cr, uid, 
                                                production_line, shipment_id, parent_move_id, 
                                                source_location_id, destination_location_id=False, context=None):
    ...
    def action_confirm(self, cr, uid, ids, context=None):
        ...
        for production in self.browse(cr, uid, ids, context=context):
            ...
            for line in production.product_lines:
                ...
                shipment_move_id = self._make_production_internal_shipment_line(cr, uid, line, shipment_id, False,\
                                 source_location_id, destination_location_id=destination_location_id, context=context)
