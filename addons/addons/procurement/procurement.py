...
class procurement_order(osv.osv):
    ...
    _columns = {
        ...
        'message': fields.char('Latest error', size=128, help="Exception occurred while computing procurement orders."),
        ...
        if procurement.move_id:
            ...
            if not (procurement.move_id.state in ('done','assigned','cancel')):
                ...
                if message:
                    ...
                    cr.execute('update procurement_order set message=%s where id=%s', (message[0:128], procurement.id))
        return ok
