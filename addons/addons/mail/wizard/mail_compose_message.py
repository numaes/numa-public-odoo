...
class mail_compose_message(osv.osv_memory):
    ...
    def send_mail(self, cr, uid, ids, context=None):
        ...
        for mail in self.browse(cr, uid, ids, context=context):
            ...
            if context.get('mail.compose.message.mode') == 'mass_mail' or len(context.get('active_ids',[])) > 1:
                ...
                for active_id in active_ids:
                    ...
                    msg_id = mail_message.schedule_with_attach(cr, uid, email_from, to_email(email_to), subject, rendered_body,
                        ...
                        subtype=mail.subtype, headers=headers, mail_server_id=mail.mail_server_id.id or False, context=context)
                    if context.get('send_now'):
