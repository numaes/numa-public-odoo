...
from tools.float_utils import float_compare, float_is_zero
    ...
    def do_partial(self, cr, uid, ids, context=None):
        ...
        for wizard_line in partial.move_ids:
            ...
            if line_uom.factor and line_uom.factor <> 0:
                if not float_is_zero(qty_in_line_uom - wizard_line.quantity, precision_rounding=max(line_uom.rounding, 0.001)):
